...
- **Year Range**: Modify supported years
- **Session Types**: Add/remove session types
- **School Codes**: Change default school code
- **Download Path**: Set custom download directory
